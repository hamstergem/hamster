...
Notice how modifying a list actually returns a new list. That's because Hamster lists immutable. Thankfully, just like Hamster sets and hashes, they're also very efficient at making copies!
