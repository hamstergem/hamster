...
* Set 1.8.7 as default Ruby version if using rvm. (Paul O'Keefe)

* Removed redundant block from rspec rake task. (Paul O'Keefe)

* Tightened up gem versions using spermy dependencies.  (Paul O'Keefe)

* Added bundler support. (Paul O'Keefe)

* Tweaked the documentation - updated the gemcutter reference to rubygems. (Paul O'Keefe)
